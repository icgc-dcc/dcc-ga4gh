...
import static org.icgc.dcc.ga4gh.common.resources.JsonNodeConverters.convertStrings;
import static org.icgc.dcc.ga4gh.common.resources.SearchHits.convertSourceToInteger;
import static org.icgc.dcc.ga4gh.common.resources.SearchHits.convertSourceToString;
import static org.icgc.dcc.ga4gh.common.resources.SearchHits.convertSourceToStringList;
...
public class EsVariantConverter
  ...
  public ObjectNode convertToObjectNode(EsVariant variant) {
    return object()
        ...
        .with(PropertyNames.ALTERNATIVE_BASES, convertStrings(variant.getAlternativeBases()))
        .end();
  }
