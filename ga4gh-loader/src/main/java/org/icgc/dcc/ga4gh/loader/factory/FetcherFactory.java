...
import org.icgc.dcc.ga4gh.loader.model.metadata.fetcher.decorators.LimitFetcherDecorator;
import org.icgc.dcc.ga4gh.loader.model.metadata.fetcher.decorators.MaxFileSizeFetcherDecorator;
import org.icgc.dcc.ga4gh.loader.model.metadata.fetcher.decorators.OrderFetcherDecorator;
import org.icgc.dcc.ga4gh.loader.model.metadata.fetcher.impl.AllFetcher;

import static com.google.common.base.Preconditions.checkArgument;
import static com.google.common.base.Preconditions.checkState;
import static org.icgc.dcc.ga4gh.loader.model.metadata.fetcher.decorators.SSMFetcherDecorator.newSSMFetcherDecorator;
  ...
  public Fetcher build(){
    ...
    if (enableAllFiles){
      if (enableDefaultPersistance){
        fetcher = AllFetcher.newAllFetcherDefaultStorageFilename(forceNewFile);
      } else {
        fetcher = AllFetcher.newAllFetcher(storageFilename, forceNewFile);
      }
    ...
    if (enableSorting){
      fetcher  = OrderFetcherDecorator.newSizeSortingFetcherDecorator(fetcher, sortAscending);
    }else{
      fetcher = OrderFetcherDecorator.newShuffleFetcherDecoratorWithSeed(fetcher, shuffleSeed);
    }
