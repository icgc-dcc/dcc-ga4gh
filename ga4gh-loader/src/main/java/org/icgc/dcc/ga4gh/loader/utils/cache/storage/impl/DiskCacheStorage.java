package org.icgc.dcc.ga4gh.loader.utils.cache.storage.impl;
...
public class DiskCacheStorage<K, V> implements CacheStorage<K, V> {
  ...
  public static <K, V> DiskCacheStorage<K, V> newDiskCacheStorage(final String name,
      final Serializer<K> keySerializer,
      final Serializer<V> idSerializer,
      final String outputDirname,
      final boolean persistFile) throws IOException {
    return new DiskCacheStorage<K, V>(name, keySerializer, idSerializer, outputDirname, persistFile);
  }

  public DiskCacheStorage(@NonNull final String name,
